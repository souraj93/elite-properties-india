...
const dubaiHomeConfig = {
  PROJECTS_LISTING: [{
    ...
    shortAddress: "Bukadra, Dubai, UAE",
    configurations: "Apartments/ Villa/ Townhouses",
    price: "On Request",
    buildUpAreaLabel: "Saleable area (Sq-Ft)",
    buildUpArea: "8588.72 - 8591.88",
    ...
    title: "Damac Hills 2",
    developerName: "Damac",
    shortAddress: "AKOYA, Dubai, UAE",
    configurations: "Villas/ Apartments",
    price: "On Request",
    buildUpAreaLabel: "Size (Sq-Ft)",
    buildUpArea: "-",
